...
| 16 | `frac_own` is overwhelmingly ≥ 0.95 — 0.5 is not a tuned knob, the threshold is inert | 6,298 of 6,427 candidates at ≥ 0.95; 10 in the whole 0.45–0.55 band; threshold sweep moves the answer 0.69% across 0.3→0.7 | `frac_own_bimodal.png` |
