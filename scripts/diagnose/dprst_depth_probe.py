...
from gfv2_params.dprst_depth.wesm_io import (  # noqa: F401 - re-exported for callers/tests
    WESM_HTTPS_URL,
    ensure_wesm_local,
    load_wesm_1m_footprints,
)

# --- CONUS coverage audit (--audit) -----------------------------------------
#
# WESM download/filter logic (`WESM_HTTPS_URL`, `ensure_wesm_local`,
# `load_wesm_1m_footprints`) lives in `gfv2_params.dprst_depth.wesm_io`
# (issue #173 Task 7b) so this diagnostic and the `gfv2_params.download.wesm`
# staging module share a single validated copy — see that module's docstring
# for the /vsis3/ vs /vsicurl/ GDAL access-path investigation notes.
