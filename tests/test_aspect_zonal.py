...
def _circular_deg_apart(a, b):
    ...
    A linear |a - b| is wrong across the 0/360 seam -- 359.99999 and 0.0 are
    7e-6 degrees apart on the circle and 360 apart on the number line. Asserting
    the linear form in THIS suite would reproduce issue #201 in the tests that
    exist to prove it fixed.
    """
