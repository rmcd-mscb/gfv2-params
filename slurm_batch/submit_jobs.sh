...
echo "worker (e.g. slurm_batch/merge_zonal_param.batch for zonal params,"
echo "slurm_batch/merge_depstor_fraction.batch for depstor fractions) with:"
echo "  sbatch --dependency=afterok:$ARRAY_JOB_ID --export=ALL,FABRIC=$FABRIC,PARAM=<name> \\"
echo "         slurm_batch/merge_<...>.batch"
